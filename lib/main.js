(function() {
  var Payments, config, _, _payments,
  ...
  module.exports = Payments = (function(_super) {
    ...
    function Payments(options) {
      ...
      if ((options != null ? options.express : void 0) == null) {
        this.redir = new _payments.Redirects(this);
      } else {
        this.redir = new _payments.Redirects(this, options.express);
      }
      this.providers = {};
      ...
      if ((options != null ? options.paymentStore : void 0) == null) {
        this.initPaymentStore(new _payments.MemoryStore());
      } else {
